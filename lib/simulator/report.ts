...
const MISSED_SIGNAL_COPY: Record<FlagId, string> = {
  ...
  "deleted-failing-test":
    "A failing test was a two-year-old warning about double-discounting — deleting it silenced the warning, not the problem.",
  "shipped-direct":
    "The release went out with no kill switch, so every unverified assumption shipped to every customer at once.",
  "blocked-release":
    "Holding the release was defensible, but nobody who depended on it was told — caution read as unreliability.",
};
