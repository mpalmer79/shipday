...
import { justAddAButton } from "@/data/scenarios";
import {
  applyDecision,
  createInitialState,
  generateReport,
...
const WORKDAY_BEATS: WorkdayBeat[] = [
  ...scenario.steps.map((step) => ({ time: step.time, label: step.title })),
  { time: "4:30 PM", label: "How it lands" },
    ...
    <AppShell>
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[240px_minmax(0,1fr)_280px]">
        <div className="order-2 flex flex-col gap-4 lg:order-1">
          <WorkdayStatus beats={WORKDAY_BEATS} currentIndex={currentBeatIndex} />
